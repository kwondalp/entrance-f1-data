...
Implemented the authorised neutral sporting-affiliation category for Mazepin 2021 rounds 1-21, preserving RAF with no country code or national flag. Age-leader eligibility now accepts complete event leader sets or per-driver totals independently of full lap charts: 209 missing events validated, 156 exact event records remain unresolved, and the separate 798-event lap-order coverage is unchanged. The original cohort remains 36/50 complete and 14 incomplete; this correction adds no fully repaired metric. All 784 accepted DOBs and 17 prior dispute resolutions persist; 12 disputed dates remain, including nonstarter McCarthy with zero start-dependent impact. Faulkner and Gould retain priority, and credible biographies or documented corrections are acceptable without mandatory civil certificates. The candidate validates 169 payloads and 69,646 rows; 53 focused Tools tests and 124 Web tests pass, with the unchanged 932-file build. Production approval, main merge and deployment remain closed.
